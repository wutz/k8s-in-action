...
pdsh -w mn02 sed -i 's/10.128.0.1/10.128.0.2/g' /etc/keepalived/keepalived.conf
...
- 代理 `containerd` 拉取镜像 (必须配置，否则无法拉取镜像)
  ...
  CONTAINERD_HTTP_PROXY=http://10.128.0.90:3128
  CONTAINERD_HTTPS_PROXY=http://10.128.0.90:3128
